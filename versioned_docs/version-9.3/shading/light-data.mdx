...
Controls for the lighting behavior when used in a Scene with Global Illumination or Baked Lightmaps. To use Baked Lighting, switch to `.poiyomi/Poiyomi Toon World` or `.poiyomi/Poiyomi Pro World` Shader.
