...
*Below is a video introduction to Global Masking, courtesy of community member Teeh. This also briefly covers it's sister feature [Global Themes](/modifiers/global-themes.mdx) as well.*
...
This section allows you to use [Vertex Colors](/vertex-options/vertex-colors.mdx) on your Mesh as a Global Mask.
