...
Select which [Global Mask](/modifiers/global-masks.mdx) to apply the BlackLight Mask **One** effects onto.
...
Select which [Global Mask](/modifiers/global-masks.mdx) to apply the BlackLight Mask **Two** effects onto.
...
Select which [Global Mask](/modifiers/global-masks.mdx) to apply the BlackLight Mask **Three** effects onto.
...
Select which [Global Mask](/modifiers/global-masks.mdx) to apply the BlackLight Mask **Four** effects onto.
