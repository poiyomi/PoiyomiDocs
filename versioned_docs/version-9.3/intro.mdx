...
If you are on an older version of Poiyomi Shaders, we highly suggest that you read [**our upgrading guidelines**](/general/upgrade/upgrade.mdx) in order to ensure you are fully up-to-date on the latest features that are documented here.
