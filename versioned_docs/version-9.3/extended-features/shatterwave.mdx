...
ShatterWave is an advanced special effect that uses the mesh's vertices to create a wavy effect across the mesh in variation. This effect is very similar to [Geometric Dissolve](/extended-features/geometric-dissolve.mdx) with the exception of it being animated in an ocean wave-like effect instead.
...
Allows you to add the currently set ShatterWave setup to be applied to an existing [Global Mask](/modifiers/global-masks.mdx) of your choice.
...
Allows you to add the currently set Under Wave setup to be applied to an existing [Global Mask](/modifiers/global-masks.mdx) of your choice.
