...
The Color Adjust section provides options for modifying the base color of the material. This is applied directly after the main [Color and Normals](/color-and-normals/color-and-normals.mdx) section, and will not affect any other sections that modify the Base Color.
...
This slot has the [Texture Packer](/thryeditor/thryeditor.mdx#texture-packer) integrated for convenience.
...
Use this section to instead use a [Global Mask](/modifiers/global-masks.mdx) for the Color Adjust Mask.
