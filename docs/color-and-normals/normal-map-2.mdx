...
:::info
This section only contains basic features for a 2nd Normal, specifically for compatibility from other shaders. To use more advanced features, we recommend using [Detail Normals & Texture](/color-and-normals/details.mdx) instead.
:::
