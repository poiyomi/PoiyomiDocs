...
sidebar_position: 6
title: Skin
description: Skin in Poiyomi Shaders can be customized to match the tone of human skin in Unity.
keywords: [skin, tone, body, detail, poiyomi, shader]
---

**Skin** applies a corrected coloring of the human skin in different Tones and features to the material. It can be used on Avatars with human skin that need an accurate representation of the skin's color.

:::warning[Experimental Feature]
This feature may contain bugs or unstable code. Use at your own risk!
:::
