...
A Normal Map will affect anything that uses the Normal of a mesh (specifically the Pixel normal, as opposed to the Vertex normal, which is the normal defined by the mesh itself). This includes features like [Shading](/shading/main.mdx), [Rim Lighting](/shading/rim-lighting.mdx), [Reflections and Specular](/shading/reflections-and-specular.mdx), [Matcaps](/shading/matcap.mdx), and many other lighting-based effects.
...
[^1]: [Special Unity Properties](/general/locking.mdx#unity-special-properties)
