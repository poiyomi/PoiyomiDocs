...
The point that acts as the center on the X-axis where the normals are aligned outwards from.

## Y

- `Type`: <PropertyIcon name="floatrange" />**Float**, Range: `-1.0 - 1.0`

The point that acts as the center on the Y-axis where the normals are aligned outwards from.

## Z

- `Type`: <PropertyIcon name="floatrange" />**Float**, Range: `-1.0 - 1.0`

The point that acts as the center on the Z-axis where the normals are aligned outwards from.
