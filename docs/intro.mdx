...
- Supported Unity Versions (Built-In Rendering Pipeline): `2021.3`, `2022.3`, and `6.0` thru `6.6`.
- Supported Unity Versions (URP): `6.0` thru `6.6`
- Supported Platforms: `Windows`, `Linux`
- Supported APIs: `Direct3D11`, `Vulkan (Experimental)`
