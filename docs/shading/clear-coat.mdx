...
If enabled, ignores shadows casted from the mesh in Clear Coat.

### Pixel Normal Mix

- `Type`: <PropertyIcon name="floatrange" />**Float**, Range: `0.0 - 1.0`

Adjusts the Normal Mix of Clear Coat.
...
Select which [Global Mask](/modifiers/global-masks.mdx) to use as the Clear Coat Mask.

### Smoothness

- `Type`: <PropertyIcon name="dropdown" />**Dropdown**, Options: `Off`/`1R`/`1G`/`1B`/`1A`/`2R`/`2G`/`2B`/`2A`/`3R`/`3G`/`3B`/`3A`/`4R`/`4G`/`4B`/`4A`

Select which [Global Mask](/modifiers/global-masks.mdx) to act as the Smoothness Strength.

### Reflection Strength

- `Type`: <PropertyIcon name="dropdown" />**Dropdown**, Options: `Off`/`1R`/`1G`/`1B`/`1A`/`2R`/`2G`/`2B`/`2A`/`3R`/`3G`/`3B`/`3A`/`4R`/`4G`/`4B`/`4A`

Select which [Global Mask](/modifiers/global-masks.mdx) to act as the Reflection Strength.

### Specular Strength

- `Type`: <PropertyIcon name="dropdown" />**Dropdown**, Options: `Off`/`1R`/`1G`/`1B`/`1A`/`2R`/`2G`/`2B`/`2A`/`3R`/`3G`/`3B`/`3A`/`4R`/`4G`/`4B`/`4A`

Select which [Global Mask](/modifiers/global-masks.mdx) to act as the Specular Strength.
