...
:::tip
Set this value to `1.0`, leaving the X Blend above to `0.0` to emulate the "AngelRing" effect.
:::
...
:::tip[Use 0.43 for Double Sided]
If using Double Sided for your Matcap, it's recommended to set this to an arbitrary value of `0.43` for the intended appearance.
:::
...
If enabled, will make the Matcap effect appear on [Outlines](/outlines/outlines.mdx).
