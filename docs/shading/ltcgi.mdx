...
Due to changes on LTCGI upstream, LTCGI will no longer be supported on Avatars in newer Worlds for performance reasons. Please keep this in mind when using this module.
:::
