...
Select which [Global Mask](/modifiers/global-masks.mdx) to use as the Backlight Mask.

### Apply to Global Mask

- `Type`: <PropertyIcon name="dropdown" />**Dropdown**, Options: `Off`/`1R`/`1G`/`1B`/`1A`/`2R`/`2G`/`2B`/`2A`/`3R`/`3G`/`3B`/`3A`/`4R`/`4G`/`4B`/`4A`

Select which [Global Mask](/modifiers/global-masks.mdx) to apply Backlight effects onto.
