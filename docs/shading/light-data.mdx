...
### Casted Shadows Softness

- `Type`: <PropertyIcon name="floatrange" />**Float**, Range: `0.0 - 1.0`

Softens the casted shadows when casted to the model.
...
Configures how intensity the specular feature in Light Volumes should appear.
...
Configures the intensity of shadows to simulate when material is exposed to a Light Volume voxel.
