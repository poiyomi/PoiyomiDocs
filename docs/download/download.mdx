...
4. Afterwards, head back to `Projects`, click `MANAGE` for the project you want to add Poiyomi Shaders to. Go down the list the list and click the <FAIcon icon="fa-solid fa-circle-plus"/> icon on ONE version you prefer to install:
   - `Poiyomi Toon`: The FREE Public version of the shader and the version you will most likely be using.
   ...
   - *If using `Poiyomi Toon`, `ThryEditor` is automatically added by the VCC. `Poiyomi Pro` supplies it's own ThryEditor version and does not need to be added.*
...
:::warning
All VCC versions of Poiyomi Shaders will automatically replace any existing copy of `_PoiyomiShaders` AND `_PoiyomiShaders/Scripts/ThryEditor` in your Project's Assets in favor of the VCC Version, if either one or two of these locations exist. Keep this in mind if you have any older versions in your Project.

If you are going to be using both Toon and Pro, please install the `Poiyomi Pro` version as it also contains a copy of Poiyomi Toon. **<u>You cannot</u> install both packages at the same time!**
:::

### Updating in ALCOM / Creator Companion

All updates to both the shader and ThryEditor are handled in your Creator Companion client of choice. Whenever a new version becomes available, the client will indicate that to you. It is highly recommended to remain on the latest version to ensure you have all the latest features, improvements, and fixes!

## Method 2: Manual Unity Package

We offer a Unity Package of our shaders for non-VCC projects. **THIS IS NOT RECOMMENDED** unless you have a very good reason otherwise.

Read the instructions below to learn how to install the package.
...
### Pro Version Method 1: VCC Package

Optionally, we offer downloading Poiyomi Pro using our VCC Package. Things work a little differently, so follow the same instructions as noted above in [Method 1: ALCOM / Creator Companion](#method-1-alcom--creator-companion) but instead of adding the `Poiyomi Toon` package to your project, you will instead add `Poiyomi Pro`.
...
### Pro Version Method 2: Unity Package
...
:::danger
**It is extremely important that you delete any existing version of Poiyomi Shaders and ThryEditor from your project before attempting to install Poiyomi Pro!** Failure to do so will cause serious errors!
:::
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Feature** | Free | Nano | Micro | Mega | Giga | Tera |
...
| [Lil Fur and Lil Fur Two Pass](/extended-features/lilfur.mdx) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| [Time Source](/modifiers/time-source.mdx) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| [Skin](/docs/color-and-normals/skin.mdx) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| [Custom Modules](/modular-shader-system/modular-shader-system.mdx) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| [Vertex Options](/vertex-options/basics.mdx), [Vertex Glitching](/vertex-options/glitching.mdx), [Vertex Colors](/vertex-options/vertex-colors.mdx), [LookAt](/vertex-options/look-at.mdx) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| [View Clip Prevention (Uzumore)](/vertex-options/view-clip-prevention.mdx) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| [All Shadow Styles](/shading/main.mdx) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| [All Rendering Presets](/general/render-preset.mdx) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| Two Pass | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
...
| [Contact Shadows](/shading/contact-shadows.mdx) | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ |
| [Squish](/special-fx/squish.mdx) | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ |
| [Triplanar Projection](/extended-features/triplanar-projection.mdx) | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ |
| [GT7 Tone Mapping](/modifiers/post-processing/gt7.mdx) | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ |
| [Lava Lamp](/raymarching/lava-lamp.mdx) | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ |
| Self Grab | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ |
| Wireframe | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ |
| NameTag | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ |
| Cubed | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ |
...
| Early Access to Unreleased and Experimental Features | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ |
