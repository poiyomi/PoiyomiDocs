...
Vertex Colors can also be used as Masks in different parts of the Shader, such as [RGBA Color Masking](/color-and-normals/rgba-color-masking.mdx#vertex-colors) and [Global Masks](/modifiers/global-masks.mdx#vertex-colors).
