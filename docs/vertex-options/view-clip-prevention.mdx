...
:::tip[Reminder]
Make sure to tag this checkbox as animated if creating toggles for this feature. Animating the [Section Header](/general/locking.mdx#section-header-checkboxes) will not work! [Read More](/general/locking.mdx#marking-properties-for-animation)
:::
