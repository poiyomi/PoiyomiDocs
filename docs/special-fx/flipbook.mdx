...
Select which [Global Mask](/modifiers/global-masks.mdx) to use for the Flipbook overall.
...
:::tip
You may animate this slider to toggle the Flipbook on the Material. Animating the [Section Header](/general/locking.mdx#section-header-checkboxes) will not work!
:::
