...
When expanded, 4 slots will be visible, one for each path. This is an integrated [Thry Texture Packer](/thryeditor/thryeditor.mdx#texture-packer), which you can use to define gradient paths for each channel.
