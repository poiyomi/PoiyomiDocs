...
Sets the Hue Shifting mode to use.
...
Enables/Disables hue shifting features for Edge Line. Unlike most sections, this toggle can be animated.
...
Fixed amount to shift the hue for the Edge Line.
...
Speed of the hue shift cycling for the Edge Line. For reference, a speed of 1 corresponds to a full cycle of the hue shift every 20 seconds.
