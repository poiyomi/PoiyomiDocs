...
The Mirror/Camera Visibility section is a very simple section that controls whether the shader should appear in VRChat Mirrors, in Cameras, or not at all. This can be used for very niche effects, such as if you want only a specific texture or effect to only show when the shader is being viewed from a Mirror, or from a Camera.
...
<em>Spot The Difference: This example image above shows two things that were changed on the Avatar as a result of using Mirror/Camera Visibility.</em>
