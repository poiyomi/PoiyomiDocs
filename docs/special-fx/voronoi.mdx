...
Same as above, but uses a [Global Mask](/modifiers/global-masks.mdx) instead to determine the Mask.
...
Enables overriding the Outer Color using Audio Link.
...
### Inner Color Override

- `Type`: <PropertyIcon name="toggle" />**Toggle**

Enables overriding the Inner Color using Audio Link.
