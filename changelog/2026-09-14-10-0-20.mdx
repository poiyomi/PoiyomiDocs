---
title: Poiyomi Toon 10.0.20 Changelog
description: Full changelog of Poiyomi Toon 10.0.20 release.
hide_table_of_contents: true
authors:
  bluwizard
tags: [shader, vrchat, major, updates, update, free, thryeditor]
---
...
- **Modular Shader System** now exposed for end-user access.
  - For more information on how to use it, [read the Docs page](https://www.poiyomi.com/modular-shader-system).
...
- Removed `Locked In Anim Sliders` from Dissolve.
  - `Locked In Anim Sliders` was often used incorrectly and were originally added at a time where tagging `RA` did not exist. Because of the existence of `RA` tagging these days, we do not see a reason to keep `Locked In Anim Sliders` in Dissolve anymore.
  - *If you have previously used this setup, please switch over to using `RA`-tagged animation workflows and have your independent animation logic be handled by your Animator's BlendTrees.*
