---
title: Poiyomi Pro 9.3.50 Changelog
description: Information regarding the release of Poiyomi Pro 9.3.50
...
This update includes some general improvements and bug fixes, as well as one big feature addition.
...
- Fixed Shadow Maps not functioning properly in Multilayer Math.
...
- Added **Korean** translation for the first time, contributed by `korea_yujin`.
- Updated **Japanese** translations, contributed by `tony_lewis`.
