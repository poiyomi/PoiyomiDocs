...
image: /img/Poiyomi-Thumbnail-Basic-V2.png
keywords: [poiyomi, shader, shaders, docs, documentation, unity, vrchat, vrc, pbr, toon, realistic, stylized, shading]
hide_title: true
hide_table_of_contents: true
---
import PoiyomiText from '@site/static/img/PoiyomiTextFull.svg';
import Heading from '@theme/Heading';

{/* ![Poiyomi Shaders Text](/img/PoiyomiTextFull@2x.png) */}

<div style={{textAlign: 'center', marginTop: '20px', marginBottom: '20px', marginLeft: '70px', marginRight: '70px'}}>
<PoiyomiText />
</div>

<h2 style={{textAlign: 'center', fontSize: '35px', margin: '2px', fontWeight: 'bold'}}>
*"<SplashText src="splashes" />"*
</h2>
