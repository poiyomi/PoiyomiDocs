...
<div class="avatar avatar--vertical" style={{margin: '20px'}}>
    ...
    <div class="avatar__intro">
        <div class="avatar__name" style={{marginTop: '5px'}}>BluWizard</div>
        <small class="avatar__subtitle">
...
<div class="avatar avatar--vertical" style={{margin: '20px'}}>
    <a
        class="avatar__photo-link avatar__photo avatar__photo--xl"
        href="https://github.com/scrn-vrc">
        <img
        src="https://github.com/scrn-vrc.png" />
    </a>
    <div class="avatar__intro">
        <div class="avatar__name" style={{marginTop: '5px'}}>SCRN-VRC</div>
        <small class="avatar__subtitle">
            Shader Developer
        </small>
    </div>
...
<div class="avatar avatar--vertical" style={{margin: '20px'}}>
    ...
    <div class="avatar__intro">
        ...
        <small class="avatar__subtitle">
            Thry Editor Author, Contributor
        </small>
    </div>
</div>
